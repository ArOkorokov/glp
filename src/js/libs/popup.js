// Модуль попапов
// Документація по роботы в шаблоне: https://template.fls.guru/template-docs/funkcional-popup.html
// сниппет (HTML): pl
...
class Popup {
	constructor(options) {
		let config = {
			...
			attributeCloseButton: 'data-close', // Атрибут для кнопки, вызывающей попап
			...
			closeEsc: true, // Зыкратие esc
			bodyLock: true, // <Блокирование скрола>
			hashSettings: {
...
// Запускаем и добавляем объект модулей
