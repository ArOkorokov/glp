...
// Настройка
Для селекту (select):
class="Имя класса" - модификатор для конкретного селектора
...
class SelectConstructor {
	constructor(props, data = null) {
		...
		this.selectClasses = {
			...
			classSelectValue: "select__value", // Значення у заголовка
			...
			classSelectActive: "_select-active", // Список выбрано
	...
	// Функція инициализации всех селектов
	...
	selectAction(selectItem) {
		...
		// Если селективы размещены в элементе с атрибутом даты data-one-select
